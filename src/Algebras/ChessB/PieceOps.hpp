...
struct piece_ctor_op : unary_function< CcString, Piece* >
{
...
struct iswhite_piece_op : unary_function< Piece, bool >
{
    bool operator () ( const Piece& p ) { return p.is_white(); }
};

struct is_op : binary_function< Piece, Piece, bool >
{
    bool operator () ( const Piece& p1, const Piece& p2 )
        { return p1.type() == p2.type(); }
};

struct samecolor_op : binary_function< Piece, Piece, bool >
{
    bool operator () ( const Piece& p1, const Piece& p2 )
        { return p1.color() == p2.color(); }
};

struct piecevalue_op : unary_function< Piece, double >
{
