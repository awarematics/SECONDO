...
struct piececount_position_op : binary_function< Position, Piece, int >
{
    int operator() ( const Position& pos, const Piece& piece ) const
    {
        ...
        PIECE p = piece.get();
        return count_if( pos.begin(), pos.end(), p == _1 );
    }
};
...
struct pos_fields_op : unary_function< Position, pair<bool, Tuple*> >
{
    ...
    {
        return list_ostream()
               << ( list_ostream() << "Field" << Symbol("field") )
               << ( list_ostream() << "Piece" << Symbol("piece") );
    }
private:
    int index_;
    ListExpr type_;
...
struct pos_moves_op : unary_function< Position, pair<bool, Tuple*> >
{
    ...
    {
        return list_ostream()
           << ( list_ostream() << "SPiece" << Symbol("piece") )
           << ( list_ostream() << "SField" << Symbol("field") )
           << ( list_ostream() << "EPiece" << Symbol("piece") )
           << ( list_ostream() << "EField" << Symbol("field") );
    }
private:
    ListExpr type_;
    move_generator gen_;
...
struct pos_moves_blocked_op : unary_function< Position, pair<bool, Tuple*> >
{
    ...
    static list_ostream type( ListExpr )
    {
        return list_ostream()
           << ( list_ostream() << "SPiece" << Symbol("piece") )
           << ( list_ostream() << "SField" << Symbol("field") )
           << ( list_ostream() << "BPiece" << Symbol("piece") )
           << ( list_ostream() << "BField" << Symbol("field") )
           << ( list_ostream() << "EPiece" << Symbol("piece") )
           << ( list_ostream() << "EField" << Symbol("field") );
    }
