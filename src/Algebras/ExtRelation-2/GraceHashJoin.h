...
implement the new hash-join operator ~gracehashjoin~.
...
of the ~gracehashjoin~ operator. As the operator implementation
...
namespace extrel2
{
class GraceHashJoinProgressLocalInfo : public ProgressLocalInfo
{
  public:
...
*/
    ...
    void calcProgressGrace( ProgressInfo& p1,
                            ProgressInfo& p2,
                            ProgressInfo* pRes,
                            Supplier s );
/*
Calculates the progress for the GRACE hash-join algorithm making use
...
/*
5 Class ~GraceHashJoinAlgorithm~

*/

class GraceHashJoinAlgorithm
{
  public:

    GraceHashJoinAlgorithm( Word wstreamA,
                             int indexAttrA,
                             Word wstreamB,
                             int indexAttrB,
                             size_t buckets,
...
collected within the partitions to the GraceHashJoinProgressLocalInfo
...
*/
    ...
    GraceHashJoinProgressLocalInfo* progress;
/*
...
/*
6 Class ~GraceHashJoinLocalInfo~
...
instance of type ~GraceHashJoinLocalInfo~ will be passed to the
~GraceHashJoinAlgorithm~ object ~ptr~.

*/
class GraceHashJoinLocalInfo: public GraceHashJoinProgressLocalInfo
{
  public:
...
/*
The destructor. Frees the GRACE hash-join algorithm instance.

*/

    GraceHashJoinAlgorithm * ptr;
/*
Pointer to GRACE hash-join algorithm
