...
public:
      ...
      */
        static unsigned long GetWidth(unsigned char* JPEGBuffer, 
                                      unsigned long JPEGBufferSize);

        static unsigned long GetHeight(unsigned char* JPEGBuffer, 
                                       unsigned long JPEGBufferSize);
      ...
      */
        static bool IsGrayScale(unsigned char* JPEGBuffer, 
                                unsigned long JPEGBufferSize);
...
private:
      ...
      */
      static void ReadJPEGHeader( unsigned char *JPEGBuffer, 
                                  unsigned long JPEGBufferSize,
                                  unsigned long *Width,
