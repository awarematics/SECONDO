...
#ifndef RASTER2_SREAL_H
#define RASTER2_SREAL_H
...
namespace raster2
{
  typedef stype<double> sreal;
  
  template <>
  struct stype_helper<double>
  {
...
namespace std
{
  template<> inline void swap<raster2::sreal>
    (raster2::sreal& a, raster2::sreal& b)
  {
      raster2::swap(a, b);
  }
}
