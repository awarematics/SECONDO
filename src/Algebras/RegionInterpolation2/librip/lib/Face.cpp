...
/*
  1.3 Convert this face to a Poly object with the given offsets and scale-factors.
...
/*
 1.10 ~leftOf~ determines if the point ~next~ is left of the segment (~pt1~ ~pt2~).
