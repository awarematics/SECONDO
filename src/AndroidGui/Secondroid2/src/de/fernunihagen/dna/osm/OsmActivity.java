...
public abstract class OsmActivity  extends Activity implements OpenStreetMapConstants {
		// ===========================================================
		// Constants
		// ===========================================================
		...
		private class SampleLocationListener implements LocationListener {
			...
			public void onLocationChanged(final Location loc) {
				if (loc != null) {
					if (OsmActivity.this.mDoGPSRecordingAndContributing)
						OsmActivity.this.mRouteRecorder.add(loc,
								OsmActivity.this.mNumSatellites);

					OsmActivity.this.onLocationChanged(loc);
				} else {
					OsmActivity.this.onLocationLost();
				}
			}
			...
			public void onStatusChanged(final String a, final int i, final Bundle b) {
				...
				OsmActivity.this.mNumSatellites = b.getInt("satellites", NOT_SET);
			}
