...
public class Point extends Point2D implements java.io.Serializable {
     ...
     * @see         javamini.awt.Point#setLocation(javamini.awt.Point)
     * @see         javamini.awt.Point#setLocation(int, int)
     * @since       1.1
     */
     ...
     * @see         javamini.awt.Point#getLocation
     * @since       1.1
     */
     ...
     * @see         javamini.awt.Point#getLocation
     * @see         javamini.awt.Point#move(int, int)
     * @since       1.1
     */
