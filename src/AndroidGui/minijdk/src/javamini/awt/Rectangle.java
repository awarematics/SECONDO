    ...
    implements Shape, java.io.Serializable
{
     ...
     * @see       #getBounds
     * @see       java.awt.Component#setBounds(javamini.awt.Rectangle)
     * @since     1.1
     */
     ...
     * @see       java.awt.Component#setLocation(javamini.awt.Point)
     * @see       #getLocation
     * @since     1.1
     */
     ...
     *                 along the Y axis
     * @see       javamini.awt.Rectangle#setLocation(int, int)
     * @see       javamini.awt.Rectangle#setLocation(javamini.awt.Point)
     */
     ...
     * @see       java.awt.Component#setSize(javamini.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
