...
public interface PathConsumer2D {
    /**
     * @see javamini.awt.geom.Path2D.Float.moveTo
     */
    public void moveTo(float x, float y);

    /**
     * @see javamini.awt.geom.Path2D.Float.lineTo
     */
    public void lineTo(float x, float y);

    /**
     * @see javamini.awt.geom.Path2D.Float.quadTo
     */
    public void quadTo(float x1, float y1,
                       float x2, float y2);

    /**
     * @see javamini.awt.geom.Path2D.Float.curveTo
     */
    ...
    /**
     * @see javamini.awt.geom.Path2D.Float.closePath
     */
     ...
     * {@link javamini.awt.geom.PathIterator PathIterator}
