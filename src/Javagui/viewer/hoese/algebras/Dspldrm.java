...
/**
 * A displayclass for the drm type 
 */
public class Dspldrm extends DsplGeneric implements ExternDisplay{
  ...
  public String toString(){
   ...
   public boolean isExternDisplayed(){
      return this==extWin.drm && extWin.isVisible();
   }

  private static class ExtWin extends JFrame{
     private JTextArea textArea = new JTextArea(5,5);
     private JButton   closeBtn = new JButton("close");
     private Dspldrm drm = null;
    ...
    public void setMatrix(Dspldrm matrix){
       drm=matrix;
       if(matrix==null){
           textArea.setText("");
       } else{
