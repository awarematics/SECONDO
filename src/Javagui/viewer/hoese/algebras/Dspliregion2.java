 ...
 */
public class Dspliregion2 extends Dsplregion2 implements Timed {
  Interval TimeBounds;

  /** A method of the Timed-Interface
   * 
   * @return the global time boundaries [min..max] this instance is defined at
   * @see <a href="Dspliregion2src.html#getTimebounds">Source</a>
   */
   ...
   * @see <a href="Dspliregion2src.html#getTimeRenderer">Source</a>
   */
   ...
   * @see <a href="Dspliregion2src.html#ScanValue">Source</a>
   */
  public void ScanValue (ListExpr v) {
    Double d;
    if (v.listLength() != 2) {                  //perhaps changes later
      Reporter.writeError("Error: No correct iregion2 expression: 2 elements needed");
      err = true;
      return;
    }
   ...
   * @see <a href="Dspliregion2src.html#getRenderObject">Source</a>
   */
   ...
   * @see sj.lang.ListExpr
   * @see <a href="Dspliregion2src.html#init">Source</a>
   */
   ...
   * @see <a href="Dspliregion2src.html#getIntervals">Source</a>
   */
