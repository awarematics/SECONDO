...
/**
 * A displayclass for JRouteInterval jrint, alphanumeric only
 */
public class Dspljrint extends DsplGeneric implements LabelAttribute{
  ...
  public void init (String name, int nameWidth, int indent, ListExpr type,
     ...
     String T = name;
     jrint = new JRouteInterval(value);
     String V = jrint.toString();
     label = V;
