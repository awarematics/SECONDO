...
tbl_open(int tbl, char *mode)
{
    ...
    fstats.st_mode = 0; // M. Spiekermann, initalization of interesting member.
                        // Otherwise some files will be return true on test S_ISFIFIO.
