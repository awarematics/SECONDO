...
5 The Parser (ASCII Version)

(File ~PDParserASCII.y~)
...
heading1	: HEAD1 paragraph_rest	{printf("\n\n");printf("\n\n");
					print($1);
					print($2);
					printf("\n\n");}
		;

heading2	: HEAD2 paragraph_rest	{printf("\n\n"); print($1);
					print($2);
					printf("\n\n");}
		;

heading3	: HEAD3 paragraph_rest	{print($1);
					print($2);
					printf("\n\n");}
		;

heading4	: HEAD4 paragraph_rest	{print($1);
					print($2);
					printf("\n\n");}
		;

heading5	: HEAD5 paragraph_rest	{print($1);
					print($2);
					printf("\n\n");}
		;
...
special_paragraph: STARTREF paragraph_rest {print($2); printf("\n\n");}
		;
...
emphasized 	: '~' unemph_list '~'	{$$ = $2;}
		;

typewriter 	: TTFORMAT  untt_list TTFORMAT	{$$ = $2;}
		;

bold_face 	: '*' unbold_list '*'	{$$ = $2;}
		;
...
special_char_format : 	'\"' plain_list '\"' REF {$$ = $2;}
