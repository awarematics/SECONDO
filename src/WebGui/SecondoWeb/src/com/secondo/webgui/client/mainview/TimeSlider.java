...
/**
*  This class represents a timeslider which displays a slider animation for a range of given dates.
*  
...
public class TimeSlider{
     ...
     * @param t2 The new value for the maximum tick
     * */
     ...
     * 
     * @param number The new number of time values 
     * */
     ...
     * 
     * @param counter The position of the slider
     * @param currentTime The current time of the slider position
     * */
