...
JNIEXPORT jobject JNICALL Java_eu_ehnes_secondoandroid_starthelper_query
  (JNIEnv *, jobject, jstring);

JNIEXPORT jstring JNICALL Java_eu_ehnes_secondoandroid_starthelper_errorMessage
  (JNIEnv *, jobject);
