...
public class emit {
  ...
  protected static void emit_action_code(PrintWriter out, production start_prod)
      ...
      if (action_code != null)
	{
      ...
      out.println("  public final java_cup10.runtime.Symbol " + 
		     pre("do_action") + "(");
      out.println("    int                        " + pre("act_num,"));
      out.println("    java_cup10.runtime.lr_parser " + pre("parser,"));
	 ...
	 6/13/96 frankf */
      ...
      out.println("      java_cup10.runtime.Symbol " + pre("result") + ";");
      out.println();
      ...
      for (Enumeration p = production.all(); p.hasMoreElements(); )
	{
	  ...
	  for (int i=0; i<prod.rhs_length(); i++) {
	    ...
	    out.println("              " + "// propagate RESULT from " +
			s.name());
	    out.println("              " + "if ( " +
	      "((java_cup10.runtime.Symbol) " + emit.pre("stack") + ".elementAt("
	  ...
	  if (emit.lr_values()) {	    
	    ...
	    int roffset = 0;
	    rightstring = "((java_cup10.runtime.Symbol)" + emit.pre("stack") + ".elementAt(" + 
	      emit.pre("top") + "-" + roffset + ")).right";	  
	    if (prod.rhs_length() == 0) 
	      leftstring = rightstring;
	    else {
	      loffset = prod.rhs_length() - 1;
	      leftstring = "((java_cup10.runtime.Symbol)" + emit.pre("stack") + ".elementAt(" + 
		emit.pre("top") + "-" + loffset + ")).left";	  
	    }
	    out.println("              " + pre("result") + " = new java_cup10.runtime.Symbol(" + 
  ...
  public static void parser(
	...
	out.println("import " + import_list.elementAt(i) + ";");
      ...
      out.println("public class " + parser_class_name + 
		  " extends java_cup10.runtime.lr_parser {");
	  ...
	  out.println("  public " + parser_class_name + 
		      "(java_cup10.runtime.Scanner s) {super(s);}");
      }
      ...
      out.println("  public java_cup10.runtime.Symbol do_action(");
      out.println("    int                        act_num,");
      out.println("    java_cup10.runtime.lr_parser parser,");
      ...
      if (scan_code != null)
	{
	  ...
	  out.println("  public java_cup10.runtime.Symbol scan()");
	  out.println("    throws java.lang.Exception");
	  out.println("    {");
