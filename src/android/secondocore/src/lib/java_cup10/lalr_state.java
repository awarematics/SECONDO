 ...
 *
 * @see     java_cup10.lalr_item
 * @see     java_cup10.lalr_item_set
 * @see     java_cup10.lalr_transition
...
public class lalr_state {
   ...
   * @see   java_cup10.lalr_item_set#compute_closure
   * @see   java_cup10.lalr_state#propagate_all_lookaheads
   */
